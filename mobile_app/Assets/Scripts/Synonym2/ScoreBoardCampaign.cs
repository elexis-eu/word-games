...
public class ScoreBoardCampaign : MonoBehaviour
{
    ...
    {
        string url = GameSettings.GETLeaderBoardCampaignURL + GameSettings.GetUserFBToken() + "&type=" + GameInfoSynonym2.info.gameMode;
