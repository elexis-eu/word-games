...
public class ChooseLevel : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        helpText.text = GameSettings.localizationManager.GetTextForKey("SYNONYM_SOLO_PICK_LEVEL_HELPER").Replace("{{LEVEL}}", firstNumber.ToString() + secondNumber.ToString() + thirdNumber.ToString());
    }
        ...
        public void PlayLevel()
    {
        ...
        GameInfoSynonym2.info.currentLevel = GetLevelNumber();
