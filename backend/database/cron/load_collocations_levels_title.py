...
mycursorDict.execute("SELECT id, filename FROM admin_imports WHERE type = 'col_levels_title' AND status = 'in_progress' LIMIT 1")
...
mycursorDict.execute("SELECT * FROM admin_imports WHERE type = 'col_levels_title' AND status = 'uploaded' LIMIT 1")
